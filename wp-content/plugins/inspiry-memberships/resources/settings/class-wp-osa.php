...
if ( ! class_exists( 'WP_OSA' ) ) :
	...
	class WP_OSA {
		...
		public function plugin_page() {
		    echo '<div class="wrap">';
		    	echo '<h1>' . esc_html__( 'Inspiry Memberships Settings', 'inspiry-memberships' ) . '</h1>';
			    $this->show_navigation();
			    $this->show_forms();
			    echo '<p>' . esc_html__( 'For help, please consult the ', 'inspiry-memberships' );
			    echo '<a href="' . esc_url( IMS_DOCS_URL ) . '" target="_blank">' . esc_html__( 'documentation', 'inspiry-memberships' ) . '</a>';
			    echo esc_html__( ' of the plugin.', 'inspiry-memberships' ) . '</p>';
			    echo '<p>' . esc_html__( 'For feedback, please provide your ', 'inspiry-memberships' );
			    echo '<a href="' . esc_url( IMS_ISSUE_URL ) . '" target="_blank">' . esc_html__( 'feedback here!', 'inspiry-memberships' ) . '</a></p>';
		    echo '</div>';
		}
