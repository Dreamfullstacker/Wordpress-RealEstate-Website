			...
			<div class="ocdi__content-container-content--main">
				<div class="ocdi-install-plugins-content">
					<div class="ocdi-install-plugins-content-header">
						<h2><?php esc_html_e( 'Install Recommended Plugins', 'realhomes-demo-import' ); ?></h2>
						<p>
							<?php esc_html_e( 'Want to use the best plugins for the job? Here is the list of awesome plugins that will help you achieve your goals.', 'realhomes-demo-import' ); ?>
						</p>
					</div>
					...
					<div class="ocdi-install-plugins-content-footer">
						...
						<a href="#" class="button button-primary js-ocdi-install-plugins"><?php esc_html_e( 'Install & Activate' , 'realhomes-demo-import' ); ?></a>
					</div>
				</div>
			</div>
